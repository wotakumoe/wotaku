...
- [Waif2x](https://unlimited.waifu2x.net/){target="_blank"} [!badge variant="ghost" text="udp"](https://waifu2x.udp.jp/){target="_blank"}  [!button target="blank" variant="primary" size="xs" icon="mark-github" text="Github"](https://github.com/nagadomi/waifu2x){target="_blank"}
...
## Software
- [Anime4K](https://github.com/bloc97/Anime4K){target="_blank"}
...
- [Smart Image](https://github.com/Decimation/SmartImage){target="_blank"}
- [Waifu2x](https://github.com/AaronFeng753/Waifu2x-Extension-GUI){target="_blank"}
...
::: tip Basic terms
The meaning of all the basic terms are covered in [**torrenting glossary**](/torrenting/glossary). Read those first, you will need them.
:::
...
| :--- | :--- | :--- |
| Anime Music Video | ![](/nyaa/1_1.png) | Anime OP/ED, fansubbed or fanmade MVs. It can have non-anime stuff too (e.g. vtubers, live action MVs). |
| English-translated | ![](/nyaa/1_2.png) | Anime with English sub/dub. By default, it contains English subtitles and Japanese audio. English dub can be found in **Dual-audio** or **Multi-dub** / **Multi-audio** releases. You will find more file name details [**here**](#anime-1). |

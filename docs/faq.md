...
You can use the [**CBconvert**](https://github.com/gen2brain/cbconvert) to compress your comic files. By default, it will use `.jpeg` and `-quality 75` as output parameters. You can configure these settings in the options menu.
:::

...
On the other hand, aggregators like [**AnimeKai**](https://animekai.to/home), [**KickassAnime**](https://kickass-anime.ru/) & [**AniZone**](https://anizone.to/) re-encode them further. They sacrifice some of the quality in favor of smaller file sizes, thereby maintaining a smoother user experience on their sites.

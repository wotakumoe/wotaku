...
| :prev: [FSRS7 fork](https://github.com/JSchoreels/anki) | :win::app::lin: |
...
- [Anki with Add-ons on Android: Guide](https://github.com/1Selxo/the_ULTIMATE_android_mining_setup) 
- [Kuri's Setup Guide](https://donkuri.github.io/learn-japanese/setup/#anki-setup) :s:
- [jp-mining-note](https://arbyste.github.io/jp-mining-note/) [||Old||](https://aquafina-water-bottle.github.io/jp-mining-note/)
...
- [Anki Audio Editor](https://ankiweb.net/shared/info/1197817101)
...
- [Kanji Trainer](https://github.com/Androix777/kanji-trainer-anki)
...
- [Kiku](https://github.com/youyoumu/kiku)
...
| Category | Software |
| :--- | :--- |
| **General** | [Immersion Reader](https://reader.immersionkit.com/) |
| ^^ | [Satori Reader](https://www.satorireader.com/) |
| **Android** | [Easy Japanese](https://play.google.com/store/apps/details?id=mobi.eup.jpnews) [:web:](https://japanese.todaiinews.com/) |
| ^^ | [Textbender](https://github.com/fruitports/android-textbender) |
| **iOS** | [Manabi Reader](https://reader.manabi.io/) |
...
- :prev: [Collection of Yomitan dictionaries (japanese)](https://nyaa.si/user/1Selxo?c=6_0)
...
- [10ten Japanese Reader](https://github.com/birchill/10ten-ja-reader) :ff::cr::sfr:
- [Anki JPDB Reader](https://github.com/Kagu-chan/anki-jpdb.reader) :ff::cr:
- [ASB Auto Subs](https://github.com/GodPepe7/asb-auto-subs) :ff::cr:
- [Japanese.io](https://www.japanese.io/) :cr:
- [jimaku player](https://github.com/sheodox/jimaku-player) :js:
- [Jiten Reader](https://jiten.moe/reader) :ff::cr:
- [JPDB Web Reader](https://github.com/max-kamps/jpd-breader) :ff::cr:
- [Language Reactor](https://www.languagereactor.com/) :cr::fm::sub:
- [mirigana](https://github.com/mirigana/mirigana) :ff::cr:
- [NihongoTube](https://nihongotube.app/) :ff::cr:
- [Rikaikun](https://github.com/melink14/rikaikun) :cr:
- [Subadub](https://github.com/rsimmons/subadub) :ff::cr:

== Condense
| Software | Platform |
| :--- | :--- |
| [Auto Condensed Audio](https://anacreondjt.gitlab.io/docs/condensed_audio/) | :py: |
| [Koemoe](https://condense.moe/) | :py: |
| [Immersion pod](https://github.com/Ajatt-Tools/impd) | :lin: |
...
| Software | Platform |
| :--- | :--- |
| [GoldenDict-NG](https://xiaoyifang.github.io/goldendict-ng/) [:help:](https://tatsumoto.neocities.org/blog/setting-up-goldendict) | |
| [Fuwari](https://github.com/dev-noru/fuwari) | :lin: |
...
| :prev: [Kizuna](https://kizuna-texthooker-ui.app/) | :web: |
...
| Software | Platform |
| :--- | :--- |
| [Lumi Reader](https://lumireader.app/) | :web: |
| [Mokuro](https://github.com/kha-white/mokuro) | :web: |
| :prev: [owokuro](https://github.com/kamperemu/owokuro) | :py: |
| [ttsu Ebook Reader](https://reader.ttsu.app/) [:src:](https://github.com/ttu-ttu/ebook-reader) | :web: |
| :prev: [yatsu](https://app.yatsu.moe/) :cs: | :web: |
...
| Software | Platform |
| :--- | :--- |
| [Asbplayer](https://killergerbah.github.io/asbplayer/) [:src:](https://github.com/asbplayer/asbplayer) | :web::cr::ff: |
| :prev: [Zak's asbplayer](https://zakwarsame.github.io/asbplayer/) [:src:](https://github.com/zakwarsame/asbplayer) | :web: |
| :prev: [Yomine](https://github.com/mcgrizzz/Yomine) | - |
| [Autocards](https://learnjapanese.moe/autocards/) | mpv |
| [hana](https://github.com/harukawu/Hana) | :ios: |
| [iinatan](https://github.com/afn478/iinatan) | :app: |
| [Jellyfin Miner](https://github.com/friedrich-de/jellyfin-subtitleminer) | - |
| [memento](https://github.com/ripose-jp/Memento) | :win::app::lin: |
| [mpvacious](https://github.com/Ajatt-Tools/mpvacious) | :win::lin: |
| [mpv subtitleminer](https://github.com/friedrich-de/mpv-subtitleminer) | mpv |
| [Nagare](https://github.com/bpwhelan/Nagare) | - |
| [SubMiner](https://github.com/ksyasuda/SubMiner) [:help:](https://docs.subminer.moe/) | mpv |
| [Yomipv](https://github.com/BrenoAqua/Yomipv) | mpv |
...
| [Shiori Reader](https://apps.apple.com/us/app/shiori-reader/id6744979827) | :ios: |
...
| [Agent](https://github.com/0xDC00/agent) | :win::app::lin: |

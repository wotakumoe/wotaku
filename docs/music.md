...
| [Monochrome](https://monochrome.st/) [:prx:](https://github.com/monochrome-music/monochrome/blob/main/INSTANCES.md#official-instance) [:src:](https://github.com/monochrome-music/monochrome) | **Amazon** |
...
| [Doujin Music](https://vk.ru/wall-60027733) | :ddl: | :vk: |
...
| [Gensokyo Radio](https://gensokyoradio.net/) | [MP3 256](https://stream.gensokyoradio.net/GensokyoRadio-enhanced.m3u) | Touhou |
...
| Category    | Links   |
|-------------|---------|
| **Equalizer** | [Equalizer314](https://github.com/bearinmindcat/Equalizer314) :and: |
| ^^            | [Poweramp Equalizer](https://play.google.com/store/apps/details?id=com.maxmpz.equalizer) :and::cs: |
...
| [Gallery Mode for Lists](https://greasyfork.org/en/scripts/434865) | **RateYourMusic** |

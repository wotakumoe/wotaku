...
- [Squidify](https://www.squidify.org/) <Badge type="tip" text="Guide" link="/guides/music/squidify" /><tooltip>Temporarily requires login, credentials are in the guide.</tooltip>
...
## Games
- [Squidify](https://www.squidify.org/) :glowing-star: <Badge type="tip" text="Guide" link="/guides/music/squidify" /><tooltip>Temporarily requires login, credentials are in the guide.</tooltip>

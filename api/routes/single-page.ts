...
const GITHUB_REPO = "https://api.github.com/repos/wotakumoe/wotaku/contents/docs/";
...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    const markdownFiles = files.filter((file: File) => {
      ...
      const isInExcludedDirectory = EXCLUDE_DIRECTORIES.some((dir) => file.path.startsWith(dir));

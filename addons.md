...
- Endless MAL Search Pages [!badge variant="dark" icon="/static/icon/fork.png" text="Fork"](https://greasyfork.org/en/scripts/409957-endless-mal-search-pages)
- [MAL Dubs](https://github.com/MAL-Dubs/MAL-Dubs) [!badge variant="dark" icon="/static/icon/fork.png" text="Fork"](https://greasyfork.org/en/scripts/376546-mal-myanimelist-dubs)

...
#### PC
Install [**uBlock Origin**](https://github.com/gorhill/uBlock) in your browser and you're done! If you want system-wide solution, you *can* use [**NextDNS**](https://nextdns.io/) but it won't be as effective as uBlock Origin. You can also use [FastForward](https://fastforward.team/) or [Bypass.city](https://bypass.city/) to *bypass* redirects.
...
#### Android
[Aniyomi](https://aniyomi.org/) & [Dantotsu](https://github.com/rebelonion/Dantotsu) can stream torrents from various sources including Nyaa.si. For that, install the Torrentio extension. You can customize good amount of things in extension settings.
...
### Where can I get the highest quality manga releases?
...
- Anime songs are uploaded on legal music streaming services. You can rip from these services using [YAMS](https://yams.tf/), [Squid.wtf](https://squid.wtf/) & [**DoubleDouble**](https://doubledouble.top/),  which can rip multiple hi-res sources.

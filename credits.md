...
[!badge variant="dark" size="2xl" icon="/static/asset/ven.png" text="**Venroot**"](https://github.com/pandorazenshi) [!badge variant="secondary" size="2xl" icon="/static/asset/zinc.png" text="**Zinklog**"](https://github.com/zinklog2)
